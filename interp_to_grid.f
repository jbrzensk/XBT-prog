...
1       write(*,*) ' Enter cruise name (8 chars) (ie, p319105a):'
        read(5,'(a8)') filen(20:27) 
        write(filen(15:18),'(a4)')filen(23:26)
        write(filen(11:13),'(a3)')filen(20:22)
! NO        if(filen(20:22).eq.'p13') filen(11:13) = 'p09'
        sfilen(1:8) = filen(20:27)
        vfilen(1:8) = filen(20:27)
        tsfilen(4:6) = filen(20:22)
! 23may2012 LL:
        if(filen(20:22).eq.'p06'.or.filen(20:22).eq.'p13') then
...
! its=2 = argo ts, all names are argo:
         ...
         sfilenargo(1:8) = filen(20:27)
         vfilenargo(1:8) = filen(20:27)
