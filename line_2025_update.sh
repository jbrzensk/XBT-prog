...
if [[ $line == 28 ]]; then
    ...
    if [[ $ch == p ]]; then
        ...
        echo $ch
        convert -density 600 -trim +repage -rotate -90 -geometry 1000x350! -flatten fer.pdf s-b.gif
...
EOF5
    ...
    echo "Running cruisehtml for ${prefix}."
